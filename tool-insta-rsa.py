...
def TumisoRSA():
	...
	print
	TumisoRSA(W+20 * '\xE2\x95\x90\xE2\x95\x90')
	print
	...
	if Choose == 1:
		...
		print
		TumisoRSA(C+'Telegram Channel BlackMafia'+W+' ...')
		time.sleep(1.5)
		os.system('xdg-open https://m.t.me/TumisoRSAcom/channel/')
		Tumisorsa()
	
	elif Choose == 3:
		print
		TumisoRSA(C+'WhatsApp Group'+W+' ...')
		time.sleep(1.5)
